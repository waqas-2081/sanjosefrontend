                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <div className="brand-content">
                                    ...
                                    <div className="brand-text">
                                    <h3>SMOKIN' HIPPIES                                    </h3>
                                        <p>Elevating Smokin' Hippies with a unique and memorable brand presence. From visuals to full identity, our work helped spark a 174% increase in revenue.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row row2">
                        ...
                        <div className="col-lg-12">
                            <div className="brand-content">
                                ...
                                <div className="brand-text">
                                <h3>BARI BLAST</h3>
                                    <p>Transforming Bari Blast with a high-energy brand identity built to stand out in a competitive market. The result? A massive 255% surge in revenue driven by impactful design.
                                    </p>
                                </div>
                            </div>
                        </div>
