...
export default function LogoBriefPage({ embedded = false }) {
  useDocumentTitle(embedded ? 'Logo Brief | Dashboard' : 'Logo Brief | San Jose Logo Design');
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      navigate(embedded ? '/dashboard/logo-projects' : '/thankyou');
    } catch (error) {
