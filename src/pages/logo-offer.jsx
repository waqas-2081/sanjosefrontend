...
const HOME_PORTFOLIO = '/assets/images/home-portfolio';

const homePortfolioItems = [
  { id: '01', wrapperClass: 'bg-01', title: 'Nacho Business', bg: `${HOME_PORTFOLIO}/bg-01.jpg`, fg: `${HOME_PORTFOLIO}/01.png` },
  { id: '02', wrapperClass: 'bg-02', title: 'Salty Soft Wash', bg: `${HOME_PORTFOLIO}/bg-02.jpg`, fg: `${HOME_PORTFOLIO}/02.png` },
  { id: '03', wrapperClass: 'bg-03', title: 'El Sombrerito', bg: `${HOME_PORTFOLIO}/bg-03.jpg`, fg: `${HOME_PORTFOLIO}/03.png` },
  { id: '04', wrapperClass: 'bg-04', title: "Buddy's Burgers", bg: `${HOME_PORTFOLIO}/bg-04.jpg`, fg: `${HOME_PORTFOLIO}/04.png` },
  { id: '05', wrapperClass: 'bg-05', title: 'Fence Pros of Texas', bg: `${HOME_PORTFOLIO}/bg-05.jpg`, fg: `${HOME_PORTFOLIO}/05.png` },
  { id: '06', wrapperClass: 'bg-06', title: 'The Wrap Ninjas', bg: `${HOME_PORTFOLIO}/bg-06.jpg`, fg: `${HOME_PORTFOLIO}/06.png` },
  { id: '07', wrapperClass: 'bg-07', title: 'Big Kahuna', bg: `${HOME_PORTFOLIO}/bg-07.jpg`, fg: `${HOME_PORTFOLIO}/07.png` } ,
  { id: '08', wrapperClass: 'bg-08', title: 'Blue Tiger', bg: `${HOME_PORTFOLIO}/bg-08.jpg`, fg: `${HOME_PORTFOLIO}/08.png` },
];
...
function useTypewriterPlaceholder(phrases, options = {}) {
  const { typingMs = 72, deletingMs = 38, pauseMs = 2000 } = options;
  ...
  useEffect(() => {
    ...
    if (!isDeleting && text === phrase) {
      ...
      timeoutId = window.setTimeout(() => setText(phrase.slice(0, text.length - 1)), deletingMs);
    } else {
      timeoutId = window.setTimeout(() => setText(phrase.slice(0, text.length + 1)), typingMs);
    }
...
export default function LogoOfferPage() {
  ...
  const heroTypewriterText = useTypewriterPlaceholder(HERO_TYPEWRITER_PHRASES);
  const showHeroTypewriter = !heroBusinessName && !heroInputFocused;
  ...
  return (
    <div className="logo-offer-page">
      <style>{`
        body.page-logo-offer .main-header--logo-offer {
          position: absolute;
          top: 0;
          left: 0;
          right: 0;
        ...
        body.page-logo-offer .main-header--logo-offer .container-fluid {
          padding: 0 clamp(16px, 4vw, 80px);
        }

        body.page-logo-offer .main-header--logo-offer__inner {
          display: flex;
          align-items: center;
        ...
        body.page-logo-offer .main-header--logo-offer__logo-btn {
          background: none;
          border: none;
          padding: 0;
          margin: 0;
        ...
        body.page-logo-offer .main-header--logo-offer__logo-video {
          width: auto;
          max-width: min(300px, 58vw);
          max-height: clamp(72px, 10vw, 98px);
          height: auto;
          display: block;
          object-fit: contain;
        ...
        .lo-hero {
          ...
          display: flex;
          align-items: center;
            background: linear-gradient(180deg, rgb(8 9 14 / 56%), rgba(8, 9, 14, 0.56)), url(/assets/images/offer.png);
        ...
        .lo-hero-typewriter-cursor {
          display: inline-block;
          margin-left: 2px;
          color: #ff5f10;
          font-weight: 400;
          animation: loHeroCursorBlink 0.9s step-end infinite;
        }
        @keyframes loHeroCursorBlink {
          0%, 100% { opacity: 1; }
          50% { opacity: 0; }
        }
        .lo-hero-go {
            ...
            <div className="col-xl-9">
              <div className="lo-hero-card text-center">
                ...
                <form className="lo-hero-form" onSubmit={handleHeroStart}>
                  <div className="lo-hero-input-wrap">
                    <input
                    ...
                    />
                    {showHeroTypewriter ? (
                      <span className="lo-hero-typewriter" aria-hidden="true">
                        {heroTypewriterText}
                        <span className="lo-hero-typewriter-cursor">|</span>
                      </span>
                    ) : null}
                  </div>
      ...
      <footer className="lo-offer-footer">
        <div className="container">
          <div className="lo-offer-footer-inner">
            <button
              type="button"
              className="lo-offer-footer-logo-wrap"
